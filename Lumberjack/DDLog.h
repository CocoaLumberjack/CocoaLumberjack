...
#define LOG_FLAG_VVERBOSE (1 << 4)  // 0...10000
...
#define LOG_LEVEL_VERBOSE (LOG_FLAG_ERROR | LOG_FLAG_WARN | LOG_FLAG_INFO | LOG_FLAG_VERBOSE)                       // 0...01111
#define LOG_LEVEL_VVERBOSE (LOG_FLAG_ERROR | LOG_FLAG_WARN | LOG_FLAG_INFO | LOG_FLAG_VERBOSE | LOG_FLAG_VVERBOSE)   // 0...11111

#define LOG_ERROR    (ddLogLevel & LOG_FLAG_ERROR)
#define LOG_WARN     (ddLogLevel & LOG_FLAG_WARN)
#define LOG_INFO     (ddLogLevel & LOG_FLAG_INFO)
#define LOG_VERBOSE  (ddLogLevel & LOG_FLAG_VERBOSE)
#define LOG_VVERBOSE (ddLogLevel & LOG_FLAG_VVERBOSE)
...
#define LOG_ASYNC_VVERBOSE (YES && LOG_ASYNC_ENABLED)
...
#define DDLogVVerbose(frmt, ...) LOG_OBJC_MAYBE(LOG_ASYNC_VVERBOSE, ddLogLevel, LOG_FLAG_VVERBOSE, 0, frmt, ##__VA_ARGS__)
...
#define DDLogCVVerbose(frmt, ...) LOG_C_MAYBE(LOG_ASYNC_VVERBOSE, ddLogLevel, LOG_FLAG_VVERBOSE, 0, frmt, ##__VA_ARGS__)
